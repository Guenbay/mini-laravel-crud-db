                            ...
                            <table class="table">
                                ...
                                @foreach($students as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/student/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa-solid fa-eye" aria-hidden="true"></i> View</button></a>
